...
This file defines top-level discovery and precedence rules for AI agents working in this repository.
...
|--------|------|---------------|-------------|
| Building Block Slide | `scripts/create-building-block-slide.py` | `pip install python-pptx Pillow` | Creates a PowerPoint slide from a building block folder's `components.png` and `summary.png`. |
...
- `standards/building-blocks/solution-building-block/standard-sbb-document.md`
- `standards/building-blocks/solution-building-block/standard-sbb-diagram.md`
...
- For PowerPoint generation, use `scripts/create-building-block-slide.py`.
