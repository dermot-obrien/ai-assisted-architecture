---
title: "AB-004 API Mediation & Gateway"
sidebar_label: "AB-004 API Mediation & Gateway"
sidebar_position: 4
---
...
|----------|-------|-------|
| **ABB ID** | `AB-004` | Unique identifier. Sequential numbering, zero-padded to 3 digits. |
...
| API Gateway -> AB-001 IAM | Identity and claims validation | I8 |
| API Gateway -> AB-002 Observability | Operational telemetry and trace emission | I6 |
| API Gateway -> AB-003 Governance | Runtime policy checks and compliance controls | I7 |
