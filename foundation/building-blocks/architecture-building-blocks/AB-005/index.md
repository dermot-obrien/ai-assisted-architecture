---
title: "AB-005 Event Streaming & Messaging"
sidebar_label: "AB-005 Event Streaming & Messaging"
sidebar_position: 5
---
...
|----------|-------|-------|
| **ABB ID** | `AB-005` | Unique identifier. Sequential numbering, zero-padded to 3 digits. |
...
| Event Platform -> AB-001 IAM | Identity controls for producers and consumers | I8 |
| Event Platform -> AB-002 Observability | Streaming telemetry and diagnostics | I6 |
| Event Platform -> AB-003 Governance | Policy controls for retention and classification | I7 |
