---
title: "AB-008 Network Connectivity & Security"
sidebar_label: "AB-008 Network Connectivity & Security"
sidebar_position: 8
---
...
|----------|-------|-------|
| **ABB ID** | `AB-008` | Unique identifier. Sequential numbering, zero-padded to 3 digits. |
...
![AB-008 Network Connectivity & Security Component Diagram](./components.png)
...
- Service mesh identities are bound to workload identity from AB-001.
...
| Network Platform -> AB-006 Compute | Network attachment for workload runtimes | I4 |
| Network Platform -> AB-001 IAM | Service mesh identity and access control | I5 |
| Network Platform -> AB-002 Observability | Network telemetry and flow diagnostics | I6 |
| Network Platform -> AB-003 Governance | Network segmentation policy enforcement | I7 |
...
|---------|------|-------------|-------------|
| 1.0 | 2026-03-08 | Initial Draft | AB-008 Network Connectivity & Security ABB created. |
