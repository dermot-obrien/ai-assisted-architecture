...
|----------|-------|-------|
| **ABB ID** | `ABB-007` | Unique identifier. Sequential numbering, zero-padded to 3 digits. |
...
![ABB-007 Storage & Persistence Platform Component Diagram](./components.png)
...
| ABB-006 Runtime Platform -> Storage Platform | Stateful workload integration | I8 |
| Storage Platform -> ABB-001 IAM | Access identity and authorisation controls | I5 |
| Storage Platform -> ABB-002 Observability | Storage and recovery telemetry | I6 |
| Storage Platform -> ABB-003 Governance | Lifecycle and retention policy enforcement | I7 |
