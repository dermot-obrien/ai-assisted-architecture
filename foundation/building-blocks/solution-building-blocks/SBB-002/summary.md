...
**SBB-002** | **Version** 1.0 | **Status** DRAFT | **Realises** ABB-002 Observability

## Purpose

Realises the Observability ABB (ABB-002) using the OpenTelemetry (OTel) Collector and Azure Monitor. It provides a vendor-neutral ingestion pipeline for logs, metrics, and traces, normalising all signals to the OTLP schema before export.
