...
**SBB-003** | **Version** 1.0 | **Status** DRAFT | **Realises** ABB-003 Governance & Policy Enforcement

## Purpose

Realises the Governance ABB (ABB-003) using Open Policy Agent (OPA). It decouples policy logic from application code, providing a high-performance evaluation engine using the Rego language for real-time authorization and operational decisions.
