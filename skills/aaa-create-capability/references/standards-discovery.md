...
|----------|-------------------------|------|
| Capability document | `standard-capability-document.md` | Always |
| Capability diagram | `standard-capability-diagram.md` | When creating an L1 domain map |
| Traceability | `standard-traceability.md` | Always |
| Frontmatter | `standard-frontmatter.md` | Always, v1.1.0 or later |
| Visual design | `visual-design-standard.md` | When drawing a map |
