---
title: "AB-008 Human-in-the-Loop"
sidebar_label: "AB-008 Human-in-the-Loop"
sidebar_position: 8
---
# Human-in-the-Loop
...
This ABB provides the technology-agnostic foundation for human–agent interaction. Channel-specific Solution Building Blocks (e.g. Email, Teams, PEGA) inherit the architecture patterns defined here and layer channel-specific bindings, constraints, and interaction models on top.
...
**Channel Adapter**  
Maps AB-008's normalised interfaces (I1/I2/I3/I4) to the target channel's native APIs and protocols (e.g., SMTP/IMAP for Email, Teams Bot Framework for Teams, PEGA Case API for PEGA). The adapter is the only part that varies per channel; all upstream agent logic and downstream audit/compliance logic remain uniform.
...
- PEGA: Case forms, decision trees, embedded workflows, history panes
...
- PEGA: Integrated with case lifecycle; define state transitions and reassignment rules
...
|---------|------|-------------|-------------|
| 0.5 | 2026-03-07 | Architecture Review | Restructured cross-cutting sections to v2.0 standard: 2.4 Identity & Access Management, 2.5 Observability, 2.6 Governance & Policy Enforcement. Replaces former Security, Manageability, and Observability & Audit sections. |
| 0.4 | 2026-03-02 | Guidance | Added Section 5 with Solution Building Block pattern guidance for channel-specific implementations (Email, Teams, PEGA). Clarifies structural pattern, shared patterns, and channel-specific constraints for SBB developers.
| 0.3 | 2026-03-02 | Architecture Review | Narrow to support SBB definition.
| 0.2 | 2025-12-15 | Initial Review | Created initial definition of Agent Human Interface as broad HITL enabler. Scope included approval gates, orchestration logic, agent identity lifecycle, and conversation state management. Status: Review. |
| 0.1 | 2025-11-01 | Initial Draft | Placeholder definition created. |
